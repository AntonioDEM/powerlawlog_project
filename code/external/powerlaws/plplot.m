function [h, hh, Rsquarepowlaw] =plplot(x, xmin, alpha)
...
switch f_dattype
    ...
    case 'REAL'
        ...
        h(1) = loglog(c(:,1),c(:,2),'b.','MarkerSize',8,'MarkerFaceColor',[1 1 1]); hold on;
        ...
        set(gca,'YLim',yr,'YTick',10.^yrt,'FontSize',14);
        ylabel('Pr(X \geq x)','FontSize',14);
